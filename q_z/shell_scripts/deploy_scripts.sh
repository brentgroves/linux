...
cp ~/src/repsys/linux/q_z/shell_scripts/end*.sh ~/bin/shell_scripts/
cp ~/src/repsys/linux/q_z/shell_scripts/start*.sh ~/bin/shell_scripts/
cp ~/src/repsys/linux/q_z/shell_scripts/cp_*.sh ~/bin/shell_scripts/
cp ~/src/repsys/linux/q_z/shell_scripts/freshstart*.sh ~/bin/shell_scripts/
cp ~/src/repsys/linux/q_z/shell_scripts/scc.sh ~/bin/shell_scripts/
