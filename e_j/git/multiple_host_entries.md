...
ssh-keygen -t ed25519 -b 4096 -C "brent.groves@linamar.com" -f ~/.ssh/gitlab_linamar
...
## 7. Check that your SSH authentication works

To test that the SSH key was added successfully, open a terminal on your device and run the following command:

```bash
ssh -T git@gitlab.com-linamar

Welcome to GitLab, @brent.groves!
```

- **[workspace](https://support.atlassian.com/bitbucket-cloud/docs/create-your-workspace/)**
